// Enhanced API endpoint with Google Sheets Integration
// Sheet ID is hardcoded - no environment variable needed!
...
// Get authenticated client for Google Sheets using env variables
